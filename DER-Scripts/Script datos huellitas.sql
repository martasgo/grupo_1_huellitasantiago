...
INSERT INTO huellitas.products (id, nombre, descripcion, precio, descuento, id_mascota, imagen, id_marca, id_edad_mascota, id_tamanio_mascota, destacado, id_categoria, id_sub_categoria, stock, activo) VALUES (17, 'Collares', 'collar para tu gatito', 3000, 10, 2, 'accesorios/collares/collares.png', 14, 1, 1, 0, 2, 6, 10, 1);
